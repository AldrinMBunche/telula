class ModerationsController < ApplicationController
  ...
  private
    ...
    def moderation_params
      params.require(:moderation).permit(:moderation_id, :training_id, :trainer_id, :unit_id, :internal_by, :internal_on, :internal_outcome, :internal_recommendation, :external_by, :external_on, :external_outcome, :external_recommendation)
    end
end
